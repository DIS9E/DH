...
<h3>💬 전문가 전망</h3><p>근거·숫자 포함 분석 2문단(500자↑)(아래 extra_context 내용을 표·리스트·문장으로 재구성)</p>
<h3>❓ Q&A (답변 포함·각 답변 2문장↑ 숫자·전망 포함)</h3>
<ul>
  <li>Q1…?<br><strong>A.</strong> …</li>
  <li>Q2…?<br><strong>A.</strong> …</li>
  <li>Q3…?<br><strong>A.</strong> …</li>
</ul>
