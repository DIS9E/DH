...
STYLE_GUIDE = """
✨ 출력 규칙 (절대 어기지 마세요)
1. **코드블록·백틱(```) 금지**, 순수 HTML만 반환.
2. 헤더 구조
   <h1>📰 (이모지 1–3개) 카피라이터-스타일 한국어 제목</h1>
   <h2>✍️ 편집자 주 — 기사 맥락 2문장</h2>
   <h3>소제목 1</h3>
     본문…
   <h3>소제목 2</h3>
     본문…
3. 제목은 러시아어·영어 금지, **완전한 한국어 + 독자의 궁금증 유발 + 관련 이모지**.
4. 본문은 원문 길이 100 % 유지(삭제·요약 금지), 톤은 친근한 대화체·질문·감탄 섞기.
5. 마지막에 반드시
   <p>🏷️ 태그: 명사 3–6개</p>
